...
class TeamView {
  ...
  TeamView(this.data) : _scopes = new Map<String, Object>() {
    ...
    var e13 = new Element.html('<div class="team-photo-small"></div>');
    ...
    var e17 = new Element.html('<div id="team-description"></div>');
    e16.elements.add(e17);
    var e18 = new Element.html('<p></p>');
    e17.elements.add(e18);
    var e19 = new Element.html('<label for="id_name">Team Name:</label>');
    e18.elements.add(e19);
    var e20 = new Element.html('<span name="name" id="id_name">${inject_3()}</span>');
    e18.elements.add(e20);
    var e21 = new Element.html('<div class="caption">All Players</div>');
    e16.elements.add(e21);
    var e22 = new Element.html('<div class="block-table"></div>');
    e16.elements.add(e22);
    var e23 = new Element.html('<table></table>');
    e22.elements.add(e23);
    var e24 = new Element.html('<thead></thead>');
    e23.elements.add(e24);
    var e25 = new Element.html('<tr></tr>');
    e24.elements.add(e25);
    var e26 = new Element.html('<td id="first"></td>');
    e25.elements.add(e26);
    var e27 = new Element.html('<td>Player</td>');
    e25.elements.add(e27);
    var e28 = new Element.html('<td>Rating</td>');
    e25.elements.add(e28);
    var e29 = new Element.html('<td class="match-overview-icons"></td>');
    e25.elements.add(e29);
    var e30 = new Element.html('<img src="http://commondatastorage.googleapis.com/cometip/images/yellow_card.png" height="28"></img>');
    e29.elements.add(e30);
    var e31 = new Element.html('<td class="match-overview-icons"></td>');
    e25.elements.add(e31);
    var e32 = new Element.html('<img src="http://commondatastorage.googleapis.com/cometip/images/red_card.png" height="28"></img>');
    e31.elements.add(e32);
    var e33 = new Element.html('<td class="match-overview-icons"></td>');
    e25.elements.add(e33);
    var e34 = new Element.html('<img src="http://commondatastorage.googleapis.com/cometip/images/soccer_ball.png" height="28"></img>');
    e33.elements.add(e34);
    var e35 = new Element.html('<tbody></tbody>');
    e23.elements.add(e35);
    var e36 = new Element.html('<div id="match-browse" class="default-block"></div>');
    _fragment.elements.add(e36);
  }
