...
$$.FilteredElementList = {"":
 ...
 set$length: function(newLength) {
  ...
  if ($.ltB(newLength, 0)) throw $.captureStackTrace($.CTC8);
...
$$.Team = {"":
 ["lib2$Team$class_name?", "class_name"],
 super: "Base",
 read$1: function(data) {
  var team_item = $.TeamView$(data, false);
  $.clear($.document().query$1('#main-content').get$nodes());
  $.add$1($.document().query$1('#main-content').get$nodes(), team_item.get$root());
 },
 get$class_name: function() {
  return this.lib2$Team$class_name;
 },
 set$class_name: function(x) {
  this.lib2$Team$class_name = x;
 }
};

$$.TeamView = {"":
 ["is_owner", "data", "_fragment", "_scopes"],
 super: "Object",
 ...
 inject_3$0: function() {
  return this.safeHTML$1($.S(this.is_owner));
 },
 inject_2$0: function() {
  return this.safeHTML$1($.S($.index(this.data, 'name')));
 },
 ...
 TeamView$2: function(data, is_owner) {
  $.add_team_templatesStyles();
  this._fragment = $._DocumentFragmentFactoryProvider_DocumentFragment();
  var e0 = $._ElementFactoryProvider_Element$html('<div id="caption"></div>');
  var t1 = this._fragment;
  $.add$1(t1.get$elements(), e0);
  var e1 = $._ElementFactoryProvider_Element$html('<div id="edit" class="aw-link"></div>');
  $.add$1(e0.get$elements(), e1);
  var e2 = $._ElementFactoryProvider_Element$html('<h1>' + $.S(this.inject_0$0()) + '</h1>');
  $.add$1(e0.get$elements(), e2);
  var e3 = $._ElementFactoryProvider_Element$html('<ul id="path"></ul>');
  $.add$1(e0.get$elements(), e3);
  var e4 = $._ElementFactoryProvider_Element$html('<li></li>');
  $.add$1(e3.get$elements(), e4);
  var t2 = this.data;
  var e5 = $._ElementFactoryProvider_Element$html('<a href="/#!/tournament/' + $.S($.index($.index(t2, 'tournament_id'), 'id')) + '/">' + $.S(this.inject_1$0()) + '</a>');
  $.add$1(e4.get$elements(), e5);
  var e6 = $._ElementFactoryProvider_Element$html('<li></li>');
  $.add$1(e3.get$elements(), e6);
  var e7 = $._ElementFactoryProvider_Element$html('<a href="/#!/tournament/' + $.S($.index($.index(t2, 'tournament_id'), 'id')) + '/teams/">Teams</a>');
  $.add$1(e6.get$elements(), e7);
  var e8 = $._ElementFactoryProvider_Element$html('<li id="current"></li>');
  $.add$1(e3.get$elements(), e8);
  var e9 = $._ElementFactoryProvider_Element$html('<a href="/#!/team/' + $.S($.index(t2, 'id')) + '/">' + $.S(this.inject_2$0()) + '</a>');
  $.add$1(e8.get$elements(), e9);
  var e10 = $._ElementFactoryProvider_Element$html('<li></li>');
  $.add$1(e3.get$elements(), e10);
  var e11 = $._ElementFactoryProvider_Element$html('<a href="/team/' + $.S($.index(t2, 'id')) + '/edit/">Edit</a>');
  $.add$1(e10.get$elements(), e11);
  var e12 = $._ElementFactoryProvider_Element$html('<li>' + $.S(this.inject_3$0()) + '</li>');
  $.add$1(e3.get$elements(), e12);
  var e13 = $._ElementFactoryProvider_Element$html('<div class="block-7"></div>');
  $.add$1(t1.get$elements(), e13);
  var e14 = $._ElementFactoryProvider_Element$html('<div class="team-photo-small"></div>');
  $.add$1(e13.get$elements(), e14);
  var e15 = $._ElementFactoryProvider_Element$html('<a href="" id="single_image"></a>');
  $.add$1(e14.get$elements(), e15);
  var e16 = $._ElementFactoryProvider_Element$html('<img alt="" src="' + $.S($.index(t2, 'photo_small')) + '" id="single_image_small"></img>');
  $.add$1(e15.get$elements(), e16);
  var e17 = $._ElementFactoryProvider_Element$html('<div class="block-12-last"></div>');
  $.add$1(t1.get$elements(), e17);
  var e18 = $._ElementFactoryProvider_Element$html('<div id="team-description"></div>');
  $.add$1(e17.get$elements(), e18);
  var e19 = $._ElementFactoryProvider_Element$html('<p></p>');
  $.add$1(e18.get$elements(), e19);
  var e20 = $._ElementFactoryProvider_Element$html('<label for="id_name">Team Name:</label>');
  $.add$1(e19.get$elements(), e20);
  var e21 = $._ElementFactoryProvider_Element$html('<span name="name" id="id_name">' + $.S(this.inject_4$0()) + '</span>');
  $.add$1(e19.get$elements(), e21);
  var e22 = $._ElementFactoryProvider_Element$html('<div class="caption">All Players</div>');
  $.add$1(e17.get$elements(), e22);
  var e23 = $._ElementFactoryProvider_Element$html('<div class="block-table"></div>');
  $.add$1(e17.get$elements(), e23);
  var e24 = $._ElementFactoryProvider_Element$html('<table></table>');
  $.add$1(e23.get$elements(), e24);
  var e25 = $._ElementFactoryProvider_Element$html('<thead></thead>');
  $.add$1(e24.get$elements(), e25);
  var e26 = $._ElementFactoryProvider_Element$html('<tr></tr>');
  $.add$1(e25.get$elements(), e26);
  var e27 = $._ElementFactoryProvider_Element$html('<td id="first"></td>');
  $.add$1(e26.get$elements(), e27);
  var e28 = $._ElementFactoryProvider_Element$html('<td>Player</td>');
  $.add$1(e26.get$elements(), e28);
  var e29 = $._ElementFactoryProvider_Element$html('<td>Rating</td>');
  $.add$1(e26.get$elements(), e29);
  var e30 = $._ElementFactoryProvider_Element$html('<td class="match-overview-icons"></td>');
  $.add$1(e26.get$elements(), e30);
  var e31 = $._ElementFactoryProvider_Element$html('<img src="http://commondatastorage.googleapis.com/cometip/images/yellow_card.png" height="28"></img>');
  $.add$1(e30.get$elements(), e31);
  var e32 = $._ElementFactoryProvider_Element$html('<td class="match-overview-icons"></td>');
  $.add$1(e26.get$elements(), e32);
  var e33 = $._ElementFactoryProvider_Element$html('<img src="http://commondatastorage.googleapis.com/cometip/images/red_card.png" height="28"></img>');
  $.add$1(e32.get$elements(), e33);
  var e34 = $._ElementFactoryProvider_Element$html('<td class="match-overview-icons"></td>');
  $.add$1(e26.get$elements(), e34);
  var e35 = $._ElementFactoryProvider_Element$html('<img src="http://commondatastorage.googleapis.com/cometip/images/soccer_ball.png" height="28"></img>');
  $.add$1(e34.get$elements(), e35);
  var e36 = $._ElementFactoryProvider_Element$html('<tbody></tbody>');
  $.add$1(e24.get$elements(), e36);
  var e37 = $._ElementFactoryProvider_Element$html('<div id="match-browse" class="default-block"></div>');
  $.add$1(t1.get$elements(), e37);
 }
};
...
$$.Base = {"":
 ...
 super: "Object",
 get$1: function(id) {
  var url = '/api/' + $.S(this.get$class_name()) + '/' + $.S(id) + '/';
  $.print(url);
  var request = $._XMLHttpRequestFactoryProvider_XMLHttpRequest();
  request.open$3('GET', url, true);
  request.setRequestHeader$2('Content-Type', 'application/json');
  $.add$1(request.get$on().get$readyStateChange(), new $.Base_get_anon(this, request));
  request.send$0();
 }
};
...
$.add_team_templatesStyles = function() {
  if ($.team_stylesheet_added !== true) {
    var styles = $.StringBufferImpl$('');
    styles.add$1('');
    $.team_stylesheet_added = true;
    $.add$1($.document().get$head().get$elements(), $._ElementFactoryProvider_Element$html('<style>' + $.S(styles.toString$0()) + '</style>'));
  }
};
...
$.TeamView$ = function(data, is_owner) {
  var t1 = new $.TeamView(is_owner, data, null, $.HashMapImplementation$());
  t1.TeamView$2(data, is_owner);
  return t1;
};
...
$.main = function() {
  $.add$1($.document().query$1('#a1004').get$on().get$click(), new $.main_anon());
  $.add$1($.document().query$1('#a1005').get$on().get$click(), new $.main_anon0());
  $.review('1004');
};
...
$.getFunctionForTypeNameOf = function() {
  ...
  if ($.contains$1(userAgent, $.CTC11) === true) return $.typeNameInChrome;
...
$.CTC11 = new Isolate.$isolateProperties.JSSyntaxRegExp(false, false, 'Chrome|DumpRenderTree');
...
$.$defineNativeClass('HTMLDocument', ["readyState?", "head?"], {
 query$1: function(selectors) {
  if ($.CTC10.hasMatch$1(selectors) === true) return this.$dom_getElementById$1($.substring$1(selectors, 1));
